...
Contact us at [contact-tsed@gmail.com](mailto:contact-tsed@gmail.com) or via [Slack](https://slack.tsed.dev/).
:::
...
::: warning Wants more?
Ask us for a custom config source! We can create a custom config source for you, tailored to your needs.
Contact us at contact-tsed@gmail.com or via [Slack](https://slack.tsed.dev/).
:::
